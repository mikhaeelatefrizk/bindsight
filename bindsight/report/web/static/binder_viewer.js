...
//
// This file is loaded by two surfaces and authored once, because two copies of
// one viewer diverge: `bindsight ui` (templates/evidence.html.j2) and the
// published documentation site (docs/results.md, generated by
// scripts/build_docs_results.py). Neither owns it. What differs between them is
// one attribute -- where a structure is fetched from -- and that is read off the
// host element rather than branched on here.
//
