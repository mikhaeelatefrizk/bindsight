...
We present \texttt{bindsight} (v0.3.0), a Python package with a
...
exposes the same pipeline through a zero-install browser UI, with no build
step and no network fetch once installed. The deployed instance at
...
directory. The same application is launched locally with \texttt{bindsight ui}.
