...
from. Existing open binder-design workflows begin at a chosen target, and
...
Software is
licensed GNU AGPL-3.0-or-later and archived at Zenodo under the concept DOI
\href{https://doi.org/10.5281/zenodo.20121495}{10.5281/zenodo.20121495}, which
...
\begin{tikzpicture}[
  ...
  \node[outbox, right=of report] (crate) {RO-Crate\\(Zenodo)};
...
(\href{https://doi.org/10.5281/zenodo.20121495}{10.5281/zenodo.20121495}).
...
(log2fc~4.36, $p_{\mathrm{adj}}\!=\!1.7\times10^{-59}$) --- a result that depends
on stratifying TCGA-BRCA by its PAM50 subtype, which otherwise averages the HER2
signal away. Antigens that are not transcriptionally over-expressed at the bulk
level --- EGFR (mutation/amplification-driven) and CEA (co-expressed in normal
colon) --- do not appear in the top-20. That outcome is an \textit{internal
consistency check} rather than a measurement of ranking discrimination: the
over-expression rule (FDR $<$ 0.05, log2fc $\geq$ 1.0) excludes such antigens
from candidacy by construction, so their absence confirms the documented rule
was applied and shows that sensitivity tracks differential-expression effect
...
\begin{itemize}
  ...
  \item \textbf{Permanent archive:} Zenodo, concept DOI \href{https://doi.org/10.5281/zenodo.20121495}{10.5281/zenodo.20121495} (resolves to the latest version)
